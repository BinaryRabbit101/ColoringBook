...
/**
 * One account's claim on one pack (DLC_SERVER.md §5, §9).
 *
 ...
 * pack simply grants itself a `source = 'free'` row the first time a signed-in
 * device asks for its bytes (see `App\Services\Entitlements`).
 *
