...
- Shell smoke: `<godot_exe> --path godot res://scenes/dev/shell_smoke.tscn` (windowed; `-- --stay`, `-- --shot-dir <dir>`). Four smokes must stay green: paint 25, palette 59, flow 95, shell 90.
